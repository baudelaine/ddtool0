 ...
 */
@WebServlet("/GetImportedKeys")
public class GetImportedKeysServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetImportedKeysServlet() {
        super();
		...
		try {
		    ...
		    while (rst.next()) {
		        ...
		        if(!keys.containsKey(fk_name)){
    		    	...
    		    	key.put("father_ids", new HashSet<String>());
    		    	key.put("key_type", "F");
		        	...
		        	key.put("seqs", seqs);
		        	keys.put(fk_name, key);
		        }
		        else{
		        	
		        	Map<String, Object> fk 	= (Map<String, Object>) keys.get(fk_name);
